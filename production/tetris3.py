...
colors = [(46,255,241),(158,255,31),(255,51,28),(255,69,224),(175,119,239),(32,169,78)] # colors of the pieces 
...
myotherfont = pygame.font.SysFont('Comic Sans MS', 15)
...
highscore = 0
pygame.display.set_icon(pygame.image.load("tetris_logo.jpg"))
...
def menu(): # function to show the menu on the right
    ...
    textsurface = myfont.render("Points : "+str(points), False, (0,0,0))# Points displayed
    fenetre.blit(textsurface, (480, 55)) 
    textsurface = myfont.render("Next Piece ", False, (0,0,0)) 
    ...
    textsurface = myfont.render("Level : "+str(level), False, (0,0,0)) # display level
    ...
    if pause == 0:
        textsurface = myfont.render("Pause : ", False, (0,0,0)) # if game on write "pause :"
        fenetre.blit(textsurface, (460, 360))
        pygame.draw.polygon(fenetre, (0,0,0), [[563,360],[563,390],[583,375]]) # draw pause symbol (triangle)
    else:
        textsurface = myfont.render("Continue : ", False, (0,0,0)) # if game paused write "continue :"
    ...
    textsurface = myfont.render("HighScore : ", False, (0,0,0)) # the next 4 lines are to display the highscore during session
